# Generated by Django 4.2.23 on 2025-06-28 14:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject_area', models.CharField(choices=[('LEXIS_STRUCTURE', 'Lexis and Structure'), ('COMPREHENSION', 'Comprehension'), ('ORALS', 'Orals'), ('GENERAL', 'General')], max_length=50)),
